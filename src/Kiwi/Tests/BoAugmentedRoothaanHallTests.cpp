...
class BoArhTest : public Test {};

TEST_F(BoArhTest, Test_HCN_RHF) {
...
TEST_F(BoArhTest, Test_H2_UHF_Triplet) {
...
TEST_F(BoArhTest, Test_H2plus_UHF) {
  std::stringstream xyzInput("2\n\n"
                             "H    0.0     0.0 0.0\n"
                             "H    0.7   0.0 0.0");
...
TEST_F(BoArhTest, Test_HCN_UHF_Doublet) {
  std::stringstream xyzInput("3\n\n"
                             "H    0.0     0.0 0.0\n"
                             "C    1.0378  0.0 0.0\n"
                             "N    2.204   0.0 0.0");
...
TEST_F(BoArhTest, Test_Benzene_RHF_SAD) {
...
TEST_F(BoArhTest, Test_HCN_RHF_Newton) {
  std::stringstream xyzInput("3\n\n"
                             "H    0.0     0.0 0.0\n"
                             "C    1.0378  0.0 0.0\n"
                             "N    2.204   0.0 0.0");
...
TEST_F(BoArhTest, Test_H2_UHF_Triplet_Newton) {
  std::stringstream xyzInput("2\n\n"
                             "H    0.0     0.0 0.0\n"
                             "H    0.7   0.0 0.0");
...
TEST_F(BoArhTest, Test_H2plus_UHF_Newton) {
  std::stringstream xyzInput("2\n\n"
                             "H    0.0     0.0 0.0\n"
                             "H    0.7   0.0 0.0");
...
TEST_F(BoArhTest, Test_HCN_UHF_Doublet_Newton) {
  std::stringstream xyzInput("3\n\n"
                             "H    0.0     0.0 0.0\n"
                             "C    1.0378  0.0 0.0\n"
                             "N    2.204   0.0 0.0");
...
TEST_F(BoArhTest, Test_Benzene_RHF_SAD_Newton) {
  std::stringstream xyzInput("12\n"
                             "benzene example\n"
                             "  C        0.00000        1.40272        0.00000\n"
                             "  H        0.00000        2.49029        0.00000\n"
